  ...
  <div class="container">
    ...
    <div>
      <div>
        ...
        <b-button type="submit" variant="primary" class="mx-2">Save</b-button>
  ...
  export default {
    ...
    methods: {
      async onSubmit() {
        ...
        await api.updateEvent(this.$route.params.id, this.event);
    ...
    async mounted() {
        let response = await api.getEvent(this.$route.params.id);
        this.event.title = response.title;
        this.event.eventDate = response.eventDate;
        this.event.body = response.body;
        this.event.startTime = response.startTime;
        this.event.endTime = response.endTime;
        this.event.venue = response.venue;
        this.event.language = response.language;
        this.event.fees = response.fees;
        this.event.speaker = response.speaker;
        this.event.speakerBlurb = response.speakerBlurb;
    }
  }
</script>
